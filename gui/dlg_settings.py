...
# project
from ops_automator.__about__ import (
    __icon_path__,
    __title__,
    __uri_homepage__,
    __uri_tracker__,
...
from ops_automator.toolbelt import PlgLogger, PlgOptionsManager
from ops_automator.toolbelt.preferences import PlgSettingsStructure
